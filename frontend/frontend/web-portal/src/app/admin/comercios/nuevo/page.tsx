...
localStorage.setItem('miph_nuevo_comercio_borrador', JSON.stringify(nuevoBorrador));
    ...
    router.push('/admin/comercios/nuevo/contrato');
};

  return (
    <div className="p-8 max-w-4xl mx-auto space-y-6">
      {/* Botón de Volver */}
      <Link href="/admin/comercios" className="flex items-center gap-2 text-slate-500 hover:text-primary transition-colors text-sm font-medium">
        <ArrowLeft size={16} />
        Volver a la lista
      </Link>
      ...
      <div className="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden">
        <form onSubmit={handleSubmit} className="p-8 space-y-8">
          ...
          <div className="pt-4 flex gap-4">
            ...
            <Link href="/admin/comercios" className="px-8 flex items-center justify-center text-slate-500 font-bold hover:bg-slate-100 rounded-xl transition-all">
              Cancelar
            </Link>
          </div>
        </form>
