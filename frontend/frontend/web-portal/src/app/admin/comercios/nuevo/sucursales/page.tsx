...
export default function SucursalesPage() {
  ...
  return (
    <div className="p-8 max-w-5xl mx-auto space-y-6">
      <Link href="/admin/comercios/nuevo/revision" className="flex items-center gap-2 text-slate-500 hover:text-primary transition-colors text-sm font-medium">
        <ArrowLeft size={16} />
        Volver a revisión
      </Link>
      ...
      {sucursales.length > 0 && (
        <div className="pt-10 flex justify-center">
          <button
            onClick={() => router.push('/admin/comercios/nuevo/qr')}
