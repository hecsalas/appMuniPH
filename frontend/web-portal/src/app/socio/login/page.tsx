...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-slate-500 p-4 relative overflow-hidden">
      ...
      <div className="max-w-md w-full space-y-8 bg-white p-10 rounded-[2.5rem] shadow-2xl border border-slate-100 relative z-10">
        <div className="text-center space-y-2">
          ...
          <p className="text-slate-600 text-sm font-medium">Inicia sesión para gestionar tus beneficios municipales</p>
        </div>
        ...
        <form onSubmit={handleLogin} className="space-y-6">
          ...
          <div className="space-y-4">
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-12 pr-4 py-4 bg-white border border-slate-200 rounded-2xl outline-none focus:ring-2 focus:ring-primary/20 transition-all text-slate-900 placeholder:text-slate-400"
              />
            </div>
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full py-4 bg-indigo-700 text-white rounded-2xl font-black shadow-lg shadow-blue-900/20 hover:bg-blue-800 transition-all flex items-center justify-center gap-2 uppercase tracking-widest text-sm"
          >
            {loading ? <Loader2 className="animate-spin" size={20} /> : 'Entrar al Portal'}
          </button>
        </form>

        <p className="text-center text-[10px] text-slate-500 uppercase font-black tracking-tighter">
