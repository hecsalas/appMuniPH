...
export default function GeneracionQRPage() {
  ...
  return (
    <div className="p-8 max-w-5xl mx-auto space-y-8 animate-in fade-in duration-500">
      <Link href="/admin/comercios/nuevo/sucursales" className="flex items-center gap-2 text-slate-500 hover:text-primary transition-colors text-sm font-medium">
        <ArrowLeft size={16} />
        Volver a sucursales
      </Link>
      ...
      <div className="pt-10 flex justify-center">
        <button
          onClick={() => router.push('/admin/comercios/nuevo/beneficios')}
