...
export default function BeneficiosAsignacionPage() {
  ...
  return (
    <div className="p-8 max-w-5xl mx-auto space-y-10 animate-in fade-in duration-500">
      <Link href="/comercios/nuevo/qr" className="flex items-center gap-2 text-slate-500 hover:text-primary transition-colors text-sm font-medium">
        <ArrowLeft size={16} />
        Volver a QR
      </Link>
      ...
      <div className="pt-10 flex justify-center">
        <button
          onClick={() => router.push('/comercios/nuevo/exito')}
