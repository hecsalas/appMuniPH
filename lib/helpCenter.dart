        ...
        child: SafeArea(
          child: SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                const Text("Contáctanos", style: TextStyle(color: Colors.white, fontSize: 18, fontWeight: FontWeight.bold)),
                ...
                const Text("Preguntas frecuentes", style: TextStyle(color: Colors.white, fontSize: 18, fontWeight: FontWeight.bold)),
                const SizedBox(height: 15),
                ...
                const SizedBox(height: 100), // Espacio para que el SnakeBar no tape nada
              ],
            ),
          ),
        ),
      ...
      child: ExpansionTile(
        ...
        children: [
          Padding(
            ...
            child: Text(answer, style: const TextStyle(color: Colors.black54, fontSize: 13)),
          ),
        ],
      ),
    );
